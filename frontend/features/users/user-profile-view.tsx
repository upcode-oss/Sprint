...
export function UserProfileView() {
  ...
  async function deleteAvatar() { setSaving(true); try { await api(`/users/${userId}/avatar`, { method: "DELETE" }); notify("Profile picture removed"); await profile.reload(); } catch (reason) { notify((reason as Error).message, "error"); } finally { setSaving(false); } }
