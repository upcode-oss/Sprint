...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-layout">
    ...
    <aside className={`sidebar upcode-sprint-sidebar ${open ? "open" : ""}`}>
      <div className="sidebar-brand"><div className="brand-mark"><Anchor /></div><div><strong>Upcode sprint</strong><span>Organization workspace</span></div><Button className="mobile-menu" style={{ marginLeft: "auto" }} variant="ghost" size="icon" onClick={() => setOpen(false)} aria-label="Close navigation"><X /></Button></div>
