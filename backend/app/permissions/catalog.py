...
class PermissionKey(StrEnum):
    ...
    USERS_PROFILE_VIEW = "users.profile.view"
    USERS_PROFILE_EDIT = "users.profile.edit"
    USERS_CONTACTS_VIEW = "users.contacts.view"
    USERS_CONTACTS_EDIT = "users.contacts.edit"
    USERS_PRESENCE_VIEW = "users.presence.view"
    USERS_PRESENCE_EDIT = "users.presence.edit"
